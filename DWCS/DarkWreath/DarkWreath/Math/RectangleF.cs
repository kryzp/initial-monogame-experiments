...
namespace DarkWreath.Math
{
    ...
    public struct RectangleF : IEquatable<RectangleF>
    {
        ...
        /// the center Vector2 will be rounded down.
        /// </remarks>
        ...
        /// </summary>
        /// <param name="x">The x coordinate of the Vector2 to check for containment.</param>
        /// <param name="y">The y coordinate of the Vector2 to check for containment.</param>
        ...
        /// </summary>
        /// <param name="value">The other RectangleF for testing.</param>
        /// <param name="result"><c>true</c> if other <see cref="RectangleF"/> intersects with this RectangleF; <c>false</c> otherwise. As an output parameter.</param>
        ...
        public static void Intersect(ref RectangleF value1, ref RectangleF value2, out RectangleF result)
        {
            ...
            {
                float rightSide = MathF.Min(value1.X + value1.Width, value2.X + value2.Width);
                float leftSide = MathF.Max(value1.X, value2.X);
                float topSide = MathF.Max(value1.Y, value2.Y);
                float bottomSide = MathF.Min(value1.Y + value1.Height, value2.Y + value2.Height);
